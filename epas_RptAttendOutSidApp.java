...
import java.sql.*;
class epas_RptAttendOutSidWin implements ActionListener{
	...
	public epas_RptAttendOutSidWin(){
		f1=new JFrame("epas");
		p1=new JPanel();
...
lblState.setFont(fnt2);
	...
	public void doConnect(){
	  ...
	  sid=dlg.showInputDialog(f1,"Enter Staff Id.","EPAS",1);
		rs=stmtView.executeQuery("select * from epas_tblAttendOut where sid='"+sid+"'");
