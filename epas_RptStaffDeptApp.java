...
import java.sql.*;
class epas_RptStaffDeptWin implements ActionListener{
...
lblState.setFont(fnt2);
	...
	public void doConnect(){
	  ...
	  dept=dlg.showInputDialog(f1,"Enter Dept. Name","EPAS",1);
		rs=stmtView.executeQuery("select * from epas_tblstaff where Dept='"+dept+"'");
