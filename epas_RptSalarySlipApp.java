...
import java.sql.*;
class epas_RptSalarySlipWin implements ActionListener{
...
fnt1=new Font("Copperplate Gothic Bold",Font.BOLD,40);
...
lblState.setFont(fnt2);
	...
	public void doConnect(){
	  ...
	  stmtView=conn.createStatement();
		rs=stmtView.executeQuery("select * from epas_tblSalarySlip");
