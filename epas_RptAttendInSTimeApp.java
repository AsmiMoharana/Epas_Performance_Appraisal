...
import java.sql.*;
class epas_RptAttendInSTimeWin implements ActionListener{
	...
	public epas_RptAttendInSTimeWin(){
		f1=new JFrame("epas");
		p1=new JPanel();
...
lblState.setFont(fnt2);
	...
	public void doConnect(){
	  ...
	  starttime=dlg.showInputDialog(f1,"Enter Staff Id.","EPAS",1);
		rs=stmtView.executeQuery("select * from epas_tblAttendIn where starttime='"+starttime+"'");
...
class epas_RptAttendInSTimeApp {
