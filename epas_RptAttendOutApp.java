...
import java.sql.*;
class epas_RptAttendOutWin implements ActionListener{
...
lblState.setFont(fnt2);
	...
	public void doConnect(){
	  ...
	  stmtView=conn.createStatement();
		rs=stmtView.executeQuery("select * from epas_tblAttendOut");
