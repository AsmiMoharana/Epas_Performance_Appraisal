...
import java.sql.*;
class epas_RptAttendOutDateWin implements ActionListener{
	...
	public epas_RptAttendOutDateWin(){
		f1=new JFrame("epas");
		p1=new JPanel();
...
lblState.setFont(fnt2);
	...
	public void doConnect(){
	  ...
	  date=dlg.showInputDialog(f1,"Enter Date","EPAS",1);
		rs=stmtView.executeQuery("select * from epas_tblAttendOut where date='"+date+"'");
...
class epas_RptAttendOutDateApp {
