...
import java.sql.*;
class epas_RptAttendInWin implements ActionListener{
...
lblState.setFont(fnt2);
	...
	public void doConnect(){
	  ...
	  stmtView=conn.createStatement();
		rs=stmtView.executeQuery("select * from epas_tblAttendIn");
